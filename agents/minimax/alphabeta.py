...
class PacmanAgent(Agent):
    ...
    def max_player(self, state, player, visited, alpha, beta):
        """
        ...
        for child, action in successors:
            ...
            value = self.minimax(child, next_p, next_v, alpha, beta)
    ...
    def min_player(self, state, player, visited, alpha, beta):
        """
        Returns the numerical value associated with the state chosen
        by the MIN player.
